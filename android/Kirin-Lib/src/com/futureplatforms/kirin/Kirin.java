...
import com.futureplatforms.kirin.internal.ArtifactMap;
import com.futureplatforms.kirin.internal.JSCallJava;
import com.futureplatforms.kirin.internal.NativeObjectHolder;
import com.futureplatforms.kirin.internal.ProxyGenerator;
import com.futureplatforms.kirin.internal.ResultsDropbox;
...
import com.futureplatforms.kirin.platformservices.DatabasesBackend;
import com.futureplatforms.kirin.platformservices.FacebookBackend;
...
import com.futureplatforms.kirin.platformservices.NetworkingBackend;
import com.futureplatforms.kirin.platformservices.SettingsBackend;

public class Kirin implements IJs2Java {
    ...
    private IDropbox mDropbox = new ResultsDropbox();
    ...
    public Kirin(Context context, Application app) {
    	this(context, app, true);
    }
    
    public Kirin(Context context, Application app, boolean initialize) {
    ...
    public class Java2Js implements IJava2Js {
        ...
        public Object getService(String proxyName) {
            return Kirin.this.getService(proxyName);
        }
    }
    ...
    private void loadServices() {
        ...
        addJavaUIObjectToJS(new FacebookBackend(mContext, prefs, java2Js), "Facebook-backend");
