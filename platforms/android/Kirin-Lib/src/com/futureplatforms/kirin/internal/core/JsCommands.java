...
public final class JsCommands {
	...
	public static final String EXECUTE_CALLBACK_METHOD_JS = "EXPOSED_TO_NATIVE.native2js.execCallbackMethod(''{0}'', ''{1}'')";
	public static final String EXECUTE_CALLBACK_METHOD_WITH_ARGS_JS = "EXPOSED_TO_NATIVE.native2js.execCallbackMethod(''{0}'', ''{1}'', {2})";
