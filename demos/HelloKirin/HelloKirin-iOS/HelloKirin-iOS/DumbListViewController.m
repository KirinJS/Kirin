...
- (void)viewWillAppear:(BOOL)animated {
	...
	[KIRIN setCurrentScreen:self forName:@"DumbListScreen"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    */
	...
	[KIRIN fireEventIntoJS:[NSString stringWithFormat:@"native2jsScreenProxy.onListItemClick(%d)", indexPath.row]];
}
